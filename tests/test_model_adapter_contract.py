...
def test_nested_dataclass_is_supported_as_model(model_case):
    ...
    assert instance.demo == DemoModel(user_id=1)
...
def test_model_adapter_contract_model_case_exists(model_case, model_case_name):
    del model_case_name
    assert model_case.adapter is not None
